...
const ARCHETYPES_RO: Record<string, {name: string; tag: string}> = {
  RI: {name: 'MAKERUL',              tag: 'Te atrag rolurile în care rezolvi probleme construind — cu mâinile și cu mintea.'},
  ...
  IA: {name: 'VIZIONARUL',           tag: 'Te atrag rolurile între idei și estetică — vezi ce nu există încă.'},
  IS: {name: 'MENTORUL',             tag: 'Te atrag rolurile între cunoaștere și oameni — explici și ridici pe alții.'},
  IE: {name: 'INOVATORUL',           tag: 'Te atrag rolurile între idei și inițiativă.'},
  IC: {name: 'DECODORUL',            tag: 'Te atrag rolurile între date și structură — găsești tiparul ascuns.'},
  AR: {name: 'ARTISTUL MATERIEI',    tag: 'Te atrag rolurile între estetică și materialitate — frumos care se atinge.'},
  AI: {name: 'ALCHIMISTUL',          tag: 'Te atrag rolurile între curiozitate și expresie — amesteci artă și știință.'},
  ...
  SR: {name: 'OMUL DE BAZĂ',         tag: 'Te atrag rolurile între oameni și acțiune practică — ești acolo când contează.'},
  SI: {name: 'EDUCATORUL',           tag: 'Te atrag rolurile între oameni și cunoaștere.'},
  SA: {name: 'AMBASADORUL',          tag: 'Te atrag rolurile între oameni și expresie creativă.'},
  SE: {name: 'LIDERUL DE ECHIPĂ',    tag: 'Te atrag rolurile între oameni: HR, sales, organizare echipe.'},
  ...
  EC: {name: 'DIRIJORUL',            tag: 'Te atrag rolurile între decizie și structură — conduci o echipă.'},
  CR: {name: 'TEHNICIANUL',          tag: 'Te atrag rolurile între execuție și sisteme.'},
  CI: {name: 'DETECTIVUL DE DATE',   tag: 'Te atrag rolurile între date și verificare — prinzi greșeala pe care n-o vede nimeni.'},
  ...
  CE: {name: 'COORDONATORUL',        tag: 'Te atrag rolurile între structură și acțiune — faci lucrurile să meargă.'},
};

const ARCHETYPES_EN: Record<string, {name: string; tag: string}> = {
  RI: {name: 'THE MAKER',            tag: 'You\'re drawn to roles where you solve problems by building — hands and mind.'},
  ...
  IA: {name: 'THE VISIONARY',        tag: 'You\'re drawn to roles between ideas and aesthetics — you see what doesn\'t exist yet.'},
  IS: {name: 'THE MENTOR',           tag: 'You\'re drawn to roles between knowledge and people — you explain and lift others up.'},
  IE: {name: 'THE INNOVATOR',        tag: 'You\'re drawn to roles between ideas and initiative.'},
  IC: {name: 'THE DECODER',          tag: 'You\'re drawn to roles between data and structure — you find the hidden pattern.'},
  AR: {name: 'THE TACTILE ARTIST',   tag: 'You\'re drawn to roles between aesthetics and materiality — beauty you can touch.'},
  AI: {name: 'THE ALCHEMIST',        tag: 'You\'re drawn to roles between curiosity and expression — you mix art and science.'},
  ...
  SR: {name: 'THE GO-TO',            tag: 'You\'re drawn to roles between people and hands-on action — you\'re there when it counts.'},
  SI: {name: 'THE EDUCATOR',         tag: 'You\'re drawn to roles between people and knowledge.'},
  SA: {name: 'THE AMBASSADOR',       tag: 'You\'re drawn to roles between people and creative expression.'},
  SE: {name: 'THE TEAM BUILDER',     tag: 'You\'re drawn to roles between people: HR, sales, team organising.'},
  ...
  EC: {name: 'THE CONDUCTOR',        tag: 'You\'re drawn to roles between decision-making and structure — you lead a team.'},
  CR: {name: 'THE TECHNICIAN',       tag: 'You\'re drawn to roles between execution and systems.'},
  CI: {name: 'THE DATA DETECTIVE',   tag: 'You\'re drawn to roles between data and verification — you catch the mistake nobody sees.'},
  ...
  CE: {name: 'THE COORDINATOR',      tag: 'You\'re drawn to roles between structure and action — you make things run.'},
};
